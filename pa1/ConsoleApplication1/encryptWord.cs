...
// Instances of encryptWord will encrypt the alphabetic characters in a given
// string using the caesar cipher.
// User can guess at the shift value, which is generated randomly when the 
// object is instantiated or reset.
// If user guesses the correct shift value or makes more than the max number
// of guesses the object will switch off.
// Resetting turns the object on, clears the guess history, and generates a
// new shift value
...
/*
  ...
  - Guessing statistics are only displayed when the user makes a correct guess
    or reaches the maximum number of guesses
  ...
  - Shift value is generated by a Random object passed to the constructor
   - Random object is passed to the constructor to avoid predictable number
     generation between multiple instances of encryptWord
*/
...
namespace ConsoleApplication1
{
  public class encryptWord
  {
    ...
    // Only called when object switches off
